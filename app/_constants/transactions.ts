...
export const TRANSACTION_PAYMENT_METHOD_ICONS = {
  ...
  [TransactionPaymentMethod.MULTIBANCO]: "bank-slip.svg",
  [TransactionPaymentMethod.CASH]: "money.svg",
  [TransactionPaymentMethod.MBWAY]: "pix.svg",
...
export const TRANSACTION_PAYMENT_METHOD_OPTIONS = [
  ...
  {
    value: TransactionPaymentMethod.MULTIBANCO,
    label:
      TRANSACTION_PAYMENT_METHOD_LABELS[TransactionPaymentMethod.MULTIBANCO],
  },
  {
